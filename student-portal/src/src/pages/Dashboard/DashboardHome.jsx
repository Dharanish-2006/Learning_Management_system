    ...
    <div className="animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="page-subtitle">
          You're on a{' '}
          <span className="text-teal font-semibold">{data.streak}-day learning streak</span>. Keep it up!
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link to="/dashboard/my-courses" className="text-sm text-teal font-semibold hover:underline">
              View all →
            </Link>
          </div>
          {courses.map(c => (
